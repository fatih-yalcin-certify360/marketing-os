...
export function personaFromQuestionnaire(
  ...
  return personaInput.parse({
    name: (answers('q01')[0] ?? 'Nieuwe persona uit tekst').slice(0, 120),
    ...
    relationToCourse: `De aansluiting op ${courseName} moet nog worden gecontroleerd aan de hand van de leerbehoefte en de opleidingsinformatie.`.slice(0, 1000),
    questionnaire,
    grounding: [],
